...
RandomRedX is a student project Python based security utility that analyzes web links and HTTP headers to detect potential vulnerabilities and misconfigurations.
